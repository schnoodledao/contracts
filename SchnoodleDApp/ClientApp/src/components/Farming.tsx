...
const Farming: React.FC<{}> = () => {
  ...
  const maxDepositAmount = () => {
    setDepositAmount(scaleDownUnits(amounts.availableAmount));
  }
  ...
  const setDepositAmount = async (amount: number) => {
    ...
    await updateVestimates();
    await updateVestiplots();
  }
                          ...
                          <div className="tw-form-control">
                            <div>
                              ...
                              <div className="tw-relative tw-flex">
                                <input type="number" min="1" max={amounts.availableAmount} placeholder={'Max: ' + amounts.availableAmount} value={amounts.depositAmount || ''} onChange={updateDepositAmount} className="depositinput" />
                                <button type="button" className="dwmbutton hidesmmd" onClick={() => setDepositAmount(amounts.availableAmount / 4)}>25%</button>
                                <button type="button" className="dwmbutton hidesmmd" onClick={() => setDepositAmount(amounts.availableAmount / 2)}>50%</button>
                                <button type="button" className="dwmbutton hidesmmd" onClick={() => setDepositAmount(amounts.availableAmount * 3 / 4)}>75%</button>
                                <button type="button" className="dwmbutton hidelg" onClick={() => setDepositAmount(amounts.availableAmount / 4)}>&frac14;</button>
                                <button type="button" className="dwmbutton hidelg" onClick={() => setDepositAmount(amounts.availableAmount / 2)}>&frac12;</button>
                                <button type="button" className="dwmbutton hidelg" onClick={() => setDepositAmount(amounts.availableAmount * 3 / 4)}>&frac34;</button>
                                <button type="button" className="maxbuttons" onClick={maxDepositAmount}>Max</button>
                              </div>
                            </div>
                          </div>
